class StarterPokemon:
    ...
    starter Pokémon types. You can see more details about them at
    [About starter Pokémon][about-starter-pokemon].
    """
...
class Bulbasaur(StarterPokemon):
    ...
    Along with [Charmander][pokedex.Charmander] and
    [Squirtle][pokedex.Squirtle], Bulbasaur is one of three starter Pokémon of
    Kanto available at the beginning of Pokémon Red, Green, Blue, FireRed, and
    LeafGreen.
    """
...
class Charmander(StarterPokemon):
    ...
    Along with [Bulbasaur][pokedex.Bulbasaur] and [Squirtle][pokedex.Squirtle],
    Charmander is one of three starter Pokémon of Kanto available at the
...
class Squirtle(StarterPokemon):
    ...
    Along with [Bulbasaur][pokedex.Bulbasaur] and
    [Charmander][pokedex.Charmander], Squirtle is one of three starter Pokémon
    of Kanto available at the beginning of Pokémon Red, Green, Blue, FireRed,
    and LeafGreen.
    """
...
class Caterpie(StarterPokemon):
    """
    For protection, it releases a horrible stench from the antenna on its head
    to drive away enemies.
    """
...
class Pidgey(StarterPokemon):
    """
    A common sight in forests and woods. It flaps its wings at ground level to
    kick up blinding sand.

    Very docile. If attacked, it will often kick up sand to protect itself
